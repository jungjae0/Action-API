...
def main():
    ...
    select_list = list(location_dict.keys())

    selected = st.selectbox('data 선택', select_list)
    print(location_dict[selected])

    df = pd.read_csv(os.path.join(data_dir, f'{location_dict[selected]}_2023.csv'))
